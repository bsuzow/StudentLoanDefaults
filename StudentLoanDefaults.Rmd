...
The total number of students in the FY2012 repayment cohort is `r round(sum(sc1415.all$CDR3_DENOM,na.rm=TRUE)/1000000,1)` million. Of these, `r round(sum(sc1415.net$CDR3_DENOM)/1000000,1)` million who had attended `r nrow(sc1415.net)` schools are included in this study.  Their average default rate is `r round(mean(sc1415.net$CDR3),3)` with the standard deviation of `r round(sd(sc1415.net$CDR3),2)`.
